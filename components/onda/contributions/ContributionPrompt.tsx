 ...
 * La variante soft_nudge ("estamos escuchando") fue eliminada por confusión UX.
 */
export function ContributionPrompt({
  ...
  // soft_nudge desactivado: no renderizar esa burbuja.
  if (invite.inviteVariant === "soft_nudge" || !invite.show) {
    return null;
  }
